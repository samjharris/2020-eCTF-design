...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = axis_aes_ctr
 PARAMETER DRIVER_VER = 1.4
 PARAMETER HW_INSTANCE = AXIS_AES_CTR_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_gpio_fifo_rng_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.2
 PARAMETER HW_INSTANCE = mb_dma_mm2s_axi_bram_ctrl_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = bram
 PARAMETER DRIVER_VER = 4.2
 PARAMETER HW_INSTANCE = mb_dma_s2mm_axi_bram_ctrl_0
END
